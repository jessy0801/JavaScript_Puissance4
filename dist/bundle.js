...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pu", function() { return pu; });
...
let pu = function(x=6, y=7, contener) {
    this.x = x;
    this.y = y;
    ...
    this.contener.append("<div>" +
        ...
        "</div>");
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#play").on('click', function() {
        pu.player1_color = hexToRgb(__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#player1-color").val());
        pu.player2_color = hexToRgb(__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#player2-color").val());
        pu.prototype.drawarea(__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#p4-content"), test);
    });
};
...
pu.prototype.drawarea = function(contener=0, arr = this.map, player = 0) {
    ...
    if (player === 0) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#p4-content header").append("<p id=\"current_player\"></p><p id=\"player1\"></p><p id=\"player2\"></p>");
        pu.player1_score=0;
        pu.player2_score=0;
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#current_player').text('current player 1  : '+((parseInt(player)%2)+1));
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#player1").text('Player 1 scrore :'+pu.player1_score);
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#player2").text('Player 2 scrore :'+pu.player2_score);
    for (let height = 0; height < arr.length; height++) {
        if (player === 0) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#table").append("<tr id='row" + height + "'></tr>");
        }

        for (let width = 0; width < arr[height].length; width++) {
            if (player === 0) {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#row" + height).append("<td class='case-contener'><canvas height='100px' width='100px' class='col" + width + "' id='map" + height + "y" + width + "'></canvas></td>");
            }
            if (arr[height][width].type === undefined) {
                ...
                for (let width = 0; width < arr[1].length; width++) {
                    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.col'+width).click(function () {
                        for (let i = arr.length-1;i>=0;i--) {
                            if (arr[i][width].type === undefined&& test===0) {
                                arr[i][width].type = 1;
                                ...
                                if (pu.prototype.check(arr, i, width, arr[i][width].player)) {
                                    ...
                                    if (arr[i][width].player === 1) {
                                        pu.player1_score += 1;
                                        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#player1").text(pu.player1_score);

                                    }
                                    else if (arr[i][width].player === 2) {
                                        pu.player2_score += 1;
                                        __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#player2").text(pu.player2_score);
                                    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__puissance4_es6_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__puissance4_es6__ = __webpack_require__(0);



__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
    new __WEBPACK_IMPORTED_MODULE_2__puissance4_es6__["pu"](6, 7,__WEBPACK_IMPORTED_MODULE_0_jquery___default()("#p4-content"));
